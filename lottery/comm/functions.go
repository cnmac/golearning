...
// format timestamp to yyyymmdd H:i:s
...
// addslashes() The function returns a string that adds a backslash before the predefined character.
...
// Get the delay from the current time to the next day's zero
...
// Obtained int64 from interface type security
...
// Get the string type from interface type security
